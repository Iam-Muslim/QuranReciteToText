...
def segments_to_json(segments: list, include_words: bool = False, include_letters: bool = False) -> dict:
    ...
    """
    return {"segments": [seg.to_json_dict(include_words=include_words, include_letters=include_letters) for seg in segments]}
